...
public adminSql()
{
	...
	SQL_QueryAndIgnore(sql, "CREATE TABLE IF NOT EXISTS `%s_history` (`id` INT(11) NOT NULL AUTO_INCREMENT, `admin_id` INT NOT NULL, `action` VARCHAR(64) NOT NULL, `panel_user_id` INT(11) NOT NULL, `before` JSON NOT NULL, `after` JSON NOT NULL, `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (`id`)) COMMENT = 'GameServices Admins Actions History'", table);
